...
from idpet.data.extract_tar_gz import extract_tar_gz
import os
import mdtraj
import numpy as np
...
class EnsembleAnalysis:
    ...
    def ens_codes(self) -> List[str]:
        ...
        """
        return [ensemble.alias for ensemble in self.ensembles]
    ...
    def trajectories(self) -> Dict[str, mdtraj.Trajectory]:
        ...
        """
        return {ensemble.alias: ensemble.trajectory for ensemble in self.ensembles}
    ...
    def get_features(self, featurization: str, normalize: bool = False, *args, **kwargs) -> Dict[str, np.ndarray]:
        ...
        for ensemble in self.ensembles:
            ...
            if featurization != "flory_exponent":
                features_dict[ensemble.alias] = features
            else:
                features_dict[ensemble.alias] = features[0]
